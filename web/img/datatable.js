 ...
 *
 */
goog.provide('neos.ui.DataTable');
 ...
 * @constructor
 */
neos.ui.DataTable = function(opt_label, opt_domHelper) {
...
goog.inherits(neos.ui.DataTable, goog.ui.Component);
 ...
 * @private
 */
neos.ui.DataTable.prototype.changeColor_ = function() {
  if (this.color_ == 'red') {
    this.color_ = 'green';
 ...
 */
neos.ui.DataTable.prototype.createDom = function() {
 ...
 */
neos.ui.DataTable.prototype.decorateInternal = function(element) {
  neos.ui.DataTable.superClass_.decorateInternal.call(this, element);
...
/** @override */
neos.ui.DataTable.prototype.disposeInternal = function() {
  neos.ui.DataTable.superClass_.disposeInternal.call(this);
  this.eh_.dispose();
  if (this.kh_) {
    this.kh_.dispose();
  }
 ...
 */
neos.ui.DataTable.prototype.enterDocument = function() {
  neos.ui.DataTable.superClass_.enterDocument.call(this);
 ...
 * document.
 */
neos.ui.DataTable.prototype.exitDocument = function() {
	neos.ui.DataTable.superClass_.exitDocument.call(this);
 ...
 *     none set.
 */
neos.ui.DataTable.prototype.getLabelText = function() {
  if (!this.getElement()) {
    return '';
  }
 ...
 * @private
 */
neos.ui.DataTable.prototype.onDivClicked_ = function(event) {
  this.changeColor_();
};
 ...
 * @private
 */
neos.ui.DataTable.prototype.onKey_ = function(event) {
 ...
 */
neos.ui.DataTable.prototype.setLabelText = function(text) {
  if (this.getElement()) {
